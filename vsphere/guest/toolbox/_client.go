...
//func (c *Client)RunCommand(ctx context.Context, command string, stdout io.Writer, stderr io.Writer) error {
//	output := []struct {
//		io.Writer
//		fd   string
//		path string
...
//	case types.VirtualMachineGuestOsFamilyWindowsGuest:
//		path = "C:\\WINDOWS\\system32\\WindowsPowerShell\\v1.0\\powershell.exe"
//		//args = []string{" -File", execfile, "| Out-File", outFile, "-encoding ASCII"}
//		args = []string{ execfile, "| Out-File", outFile, "-encoding ASCII"}
//		//args = []string{" -File", execfile, ">", outFile}
//		//args = []string{"C:\\command.ps1", "| Out-File", outFile,"-encoding ASCII"}
//		//args = []string{"Get-Process",">", outFile}
//		//args = []string{"-Command","\"& {Get-Process;Get-Service;ipconfig}\"","| Out-File", outFile,"-encoding ASCII"}
//	default:
//		//if !strings.ContainsAny(cmd.Path, "/") {
//		//	// vmware-tools requires an absolute ProgramPath
//		//	// Default to 'bash -c' as a convenience
...
//
//	var buf = new(strings.Builder)
//	f, _, err := c.Download(ctx, outFile)
//
//	if err != nil {
//		return err
//	}
